...
import 'package:nm/screens/carwashscreen/car_search_screen.dart';
import 'package:nm/screens/register.dart';
import 'package:nm/screens/laundryscreen/laundry_search_screen.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Route newRoute =
                  MaterialPageRoute(builder: (context) => CarSearchScreen());
